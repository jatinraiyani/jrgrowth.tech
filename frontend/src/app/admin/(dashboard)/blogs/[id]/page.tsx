...
import { Save, ArrowLeft, Image as ImageIcon, Settings, Globe, ChevronDown, Loader2 } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="flex items-center justify-between bg-white p-4 rounded-2xl border border-slate-200 shadow-sm sticky top-24 z-20">
        <div className="flex items-center gap-4">
          <Link href="/admin/blogs" className="p-2 hover:bg-slate-100 rounded-xl transition-colors">
